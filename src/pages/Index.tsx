...
import Trajetoria from "@/components/site/Trajetoria";
import Livro from "@/components/site/Livro";
  ...
  return (
    <main className="bg-background text-foreground">
      ...
      <a
        ...
        className="fixed bottom-5 right-5 z-50 w-14 h-14 rounded-full bg-gold text-primary-foreground flex items-center justify-center shadow-elegant hover:bg-gold-light hover:scale-105 transition-all"
      >
